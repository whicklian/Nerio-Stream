      ...
      <form onSubmit={handleSubmit} className="relative flex items-center w-full group">
        <div className="relative w-full flex items-center">
          ...
          <input
            ...
            className="w-full h-9 sm:h-10 rounded-md border border-white/10 bg-[#17191d]/90 text-xs sm:text-sm text-white placeholder-[#aaaaaa] focus:outline-none focus:border-red-500/80 hover:border-red-500/40 transition-all duration-200 shadow-inner"
          />
