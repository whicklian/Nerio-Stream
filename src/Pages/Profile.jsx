            ...
            <div className="hero-section flex flex-col md:flex-row items-start md:items-center justify-between gap-6 p-6 md:p-8 rounded-3xl bg-gradient-to-r from-zinc-900/90 via-zinc-900/80 to-red-950/40 border border-red-500/20 backdrop-blur-xl shadow-2xl mb-8 relative overflow-hidden">
                ...
                <div className="flex items-center gap-3 relative z-10 w-full md:w-auto justify-end md:justify-center">
                    {currentUser ? (
                        <button
                            onClick={logout}
                            className="inline-flex items-center justify-center gap-2 rounded-lg border border-red-500/40 bg-red-600/10 px-4 py-2.5 text-xs font-bold tracking-[0.04em] text-red-200 shadow-[0_0_0_1px_rgba(239,68,68,0.12)] transition-all duration-200 hover:bg-red-600/15 hover:text-white hover:border-red-500/60 cursor-pointer whitespace-nowrap"
                        >
                        ...
                        <button
                            ...
                            className="inline-flex items-center justify-center gap-2 rounded-lg bg-gradient-to-r from-red-600 via-red-500 to-rose-600 px-4 py-2.5 text-xs font-extrabold tracking-[0.04em] text-white shadow-[0_10px_25px_rgba(239,68,68,0.35)] transition-all duration-200 hover:from-red-500 hover:to-red-600 hover:-translate-y-0.5 cursor-pointer whitespace-nowrap"
                        >
                            <svg className="h-3.5 w-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
