    ...
    <div className="auth-screen">
      ...
      <div className="auth-stage">
        <div className="auth-visual">
          <span className="auth-brand-tag">NERIO STREAM</span>
          <h1>Stream smarter.</h1>
          <p>
            Discover blockbuster hits, trending TV, and your own personalized watchlist in one premium app.
          </p>
          <ul className="auth-visual-list">
            <li>Curated recommendations</li>
            <li>Sync favorites across devices</li>
            <li>Watch without the clutter</li>
          </ul>
        </div>
