    ...
    <div className="auth-page-container">
      ...
      <div className="auth-page-card">
        ...
        <div className="auth-page-banner">
          <div>
            <Link to="/" className="inline-flex items-center gap-2 text-xl font-black text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 via-indigo-300 to-cyan-400 tracking-tight mb-8">
              <span>🎬</span> NERIO STREAM
            </Link>

            <h2 className="text-2xl md:text-3xl font-black text-white leading-tight mb-3">
              {isSignUp ? "Unlock Unlimited 4K Streaming" : "Welcome Back Streamer"}
            </h2>
            <p className="text-xs md:text-sm text-slate-400 leading-relaxed mb-8">
              Sync your movie watchlists, resume episodes across multiple screens, and personalize your high-definition streaming experience.
            </p>
            ...
            <div className="space-y-4">
              <div className="auth-feature-item">
                ...
                <div>
                  <div className="text-xs font-semibold text-white">Cross-Device Synchronization</div>
              ...
              <div className="auth-feature-item">
                <div className="auth-feature-icon-wrap">⚡</div>
                <div>
                  <div className="text-xs font-semibold text-white">Direct Native Video Playback</div>
                  <div className="text-[11px] text-slate-400">Ad-free, high-speed HLS and MP4 streaming engine</div>
                </div>
              </div>

              <div className="auth-feature-item">
                <div className="auth-feature-icon-wrap">☁️</div>
                <div>
                  <div className="text-xs font-semibold text-white">Cloud Favorites & Custom Streams</div>
                  <div className="text-[11px] text-slate-400">Save custom streams and bookmarks safely</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mt-8 pt-6 border-t border-slate-800/80 text-[11px] text-slate-500 flex items-center justify-between">
            <span>🛡️ Protected by Firebase Security</span>
            <span className="text-indigo-400 font-semibold">SSL Encrypted</span>
          </div>
        </div>

        {/* Right Side: Interactive Form */}
        <div className="p-8 md:p-10 flex flex-col justify-center bg-slate-950/70 backdrop-blur-xl">
          {/* Header */}
          <div className="mb-6">
            <h3 className="text-2xl font-black text-white tracking-tight">
              {isSignUp ? "Create Your Account" : "Sign In to Nerio"}
            </h3>
